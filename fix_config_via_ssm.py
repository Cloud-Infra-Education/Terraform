#!/usr/bin/env python3
"""
SSM을 통해 Bastion의 config.py 수정 및 서버 실행
"""
import subprocess
import json
import time
...
def main():
    print("=" * 60)
    print("Bastion에서 config.py 수정 및 서버 실행")
    print("=" * 60)
    ...
    commands1 = [
        ...
        "python3 -c 'from app.core.config import settings; print(\"✅ config.py 수정 확인\")' 2>&1 || echo '수정 필요'"
    ]
